...
public class JinMeiOrderDao {
    private static final String TAG = "JinMeiOrderDao";
    ...
    public JinMeiOrderDao(Context context) {
    ...
    public boolean isDataExist(){
        ...
        try {
            ...
            cursor = db.query(myOrderDBHelper.TABLE_NAME_JIN_MEI, new String[]{"COUNT(Id)"}, null, null, null, null, "id desc");
    ...
    public void initTable(){
        ...
        try {
            ...
            db.execSQL("insert into " + myOrderDBHelper.TABLE_NAME_JIN_MEI + " (Id, content, danjia, date) values (0,'','', '')");
            /*for(int j = 0; j<50; j++){
                db.execSQL("insert into " + myOrderDBHelper.TABLE_NAME_JIN_MEI + " (Id, content, danjia, date) values ("+j+", "+ " '"+""+j+"'"+", 'danjia', 'date')");
            }*/
    ...
    public List<myOrder> getAllDate(){
        ...
        try {
            db = ordersDBHelper.getReadableDatabase();
            // select * from Orders
            cursor = db.query(myOrderDBHelper.TABLE_NAME_JIN_MEI, ORDER_COLUMNS, null, null, null, null, "id desc");
    ...
    public boolean insertDate(String content,String danjia,String date){
        ...
        try {
            ...
            db.insertOrThrow(myOrderDBHelper.TABLE_NAME_JIN_MEI, null, contentValues);
    ...
    public boolean deleteOrder(int id) {
        ...
        try {
            ...
            db.delete(myOrderDBHelper.TABLE_NAME_JIN_MEI, "Id = ?", new String[]{String.valueOf(id)});
            db.setTransactionSuccessful();
            return true;
        } catch (Exception e) {
            Log.e(TAG, "", e);
    ...
    public boolean updateOrder(){
        ...
        try {
            ...
            db.update(myOrderDBHelper.TABLE_NAME_JIN_MEI,
                    cv,
                    "Id = ?",
    ...
    public List<myOrder> getBorOrder(){
        ...
        try {
            ...
            cursor = db.query(myOrderDBHelper.TABLE_NAME_JIN_MEI,
                    ORDER_COLUMNS,
                    "CustomName = ?",
                    new String[] {"Bor"},
                    null, null, null);
    ...
    public myOrder getMaxOrderPrice(){
        ...
        try {
            ...
            cursor = db.query(myOrderDBHelper.TABLE_NAME_JIN_MEI, new String[]{"Id", "CustomName", "Max(OrderPrice) as OrderPrice", "Country"}, null, null, null, null, null);
